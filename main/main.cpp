...
{	
	...
	while(exit!= 1){
		...
		if (s == ' ')						//if the player presses the 'SPACEBAR' key he uses the magic potion
		{
		...
		if (s == 'a' || s == 'A')					//if the player presses the 'A' key the avatar goes left
		{
			system("clear");
			daynightcount++;
		...
		if (s == 'd' || s == 'D')					//if the player presses the 'D' key the avatar goes right
		{
			system("clear");
		...
		if (s == 'w' || s == 'W')					//if the player presses the 'W' key the avatar goes up
		{
			system("clear");
			daynightcount++;
		...
		if (s == 'p' || s == 'P')			//if the player presses the 'P' key the game pauses		
		{
			system("clear");
		...
		if (s == 's' || s == 'S')					//if the player presses the 'S' key the avatar goes down
		{
			system("clear");
			daynightcount++;
		...
		if (s == '0')					//if the player presses the '0' key the game is terminated
		{	
			system("clear");
